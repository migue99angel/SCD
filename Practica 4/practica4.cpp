// -----------------------------------------------------------------------------
// Miguel Ángel Posadas Arráez B2
//
...
int main( int argc, char *argv[] )
{
   ...
   while( true ) // ciclo principal
   {
      ...
      for( int i = 1 ; i <= 4 ; i++ ) // ciclo secundario (4 iteraciones)
      {
         ...
         cout << "\tEl tiempo de espera es de " << milliseconds_f(duracion).count() << endl;

         if(milliseconds_f(duracion) > milliseconds(20)){
            cerr << "\tSe ha retrasado el instante final más de lo esperado" << endl;
            exit(0);
         }
      }
   }
